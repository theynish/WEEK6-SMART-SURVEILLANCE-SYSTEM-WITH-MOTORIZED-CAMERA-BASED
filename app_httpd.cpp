...
//NEW CODE____________
extern int detectedFaceX;
extern int detectedFaceY;
extern bool facedetect1;
//END OF NEW CODE________________
...
static void draw_face_boxes(fb_data_t *fb, std::list<dl::detect::result_t> *results, int face_id)
{
    ...
    for (std::list<dl::detect::result_t>::iterator prediction = results->begin(); prediction != results->end(); prediction++, i++)
    {
        ...
        //NEW CODE________________
        facedetect1 = true;
        detectedFaceX = x;
        detectedFaceY = y;
        char str_x[16];
        snprintf(str_x, sizeof(str_x), "X: %d", x);
        char str_y[16];
        snprintf(str_y, sizeof(str_y), "Y: %d", y);
        ...
        fb_gfx_print(fb, x, text_y1, color, str_x);
        fb_gfx_print(fb, y, text_y2, color, str_y);
        //END OF NEW CODE____________________
#if TWO_STAGE
